                        ...
                        <nav className="navbar is-transparent" role="navigation" aria-label="main navigation">
                            ...
                            <div id="navigation" className="navbar-menu">
                                <div className="navbar-start">
                                    ...
                                    <a onClick={this.toggleDarkMode} className="navbar-item is-hidden-desktop">dark/light mode</a>
                                ...
                                <div className="navbar-end">
                                    <a onClick={this.toggleDarkMode} className="navbar-item is-hidden-mobile">
                                        {adjustSymbol}
                                    </a>
                                </div>
                            </div>
